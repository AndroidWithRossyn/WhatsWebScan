...
public class MultiContactPickerActivity extends AppCompatActivity implements MaterialSearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gb_activity_multi_contact_picker);
        ...
        tvSelectAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(allSelected)
                    tvSelectAll.setText(getString(R.string.gb_tv_unselect_all_btn_text));
                else
                    tvSelectAll.setText(getString(R.string.gb_tv_select_all_btn_text));
            }
        });
    ...
    private void updateSelectBarContents(int totalSelectedContacts){
        ...
        if(totalSelectedContacts > 0) {
            tvSelectBtn.setText(getString(R.string.gb_tv_select_btn_text_enabled, String.valueOf(totalSelectedContacts)));
        } else {
            tvSelectBtn.setText(getString(R.string.gb_tv_select_btn_text_disabled));
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.gb_mcp_menu_main, menu);
