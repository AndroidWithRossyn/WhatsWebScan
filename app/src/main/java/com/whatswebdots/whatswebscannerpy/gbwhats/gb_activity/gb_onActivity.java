...
import com.whatswebdots.whatswebscannerpy.gbwhats.gb_local.RatingDialogBuilder;
import com.whatswebdots.whatswebscannerpy.gbwhats.R;
import com.whatswebdots.whatswebscannerpy.gbwhats.gb_local.gb_all_native_ads;
import com.whatswebdots.whatswebscannerpy.gbwhats.gb_local.gb_AdsPrefs;
...
//            build.show();
    ...
    public void onBackPressed() {
        ...
        FrameLayout native_container =  dialog.findViewById(R.id.native_container);

        if (whatspref.getAdd_Status().equals("1")) {
            gb_all_native_ads.NativeAdd(gb_onActivity.this, native_container);
        }
