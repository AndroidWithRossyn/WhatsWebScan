...
public class ArcView extends ShapeOfView {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        super.setClipPathCreator(new ClipPathManager.ClipPathCreator() {
            /* class com.whatsweb.whatswebscanner.gbwhats.arclayout.ArcView.AnonymousClass1 */

            @Override // com.whatsweb.whatswebscanner.gbwhats.arclayout.ClipPathManager.ClipPathCreator
