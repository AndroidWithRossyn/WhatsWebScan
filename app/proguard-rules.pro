...
-keepclassmembers class  com.whatswebdots.whatswebscannerpy.gbwhats.gb_local.gb_model.* { *; }
-keepclassmembers class  com.whatswebdots.whatswebscannerpy.gbwhats.gb_in.gb_CountryModal.*{ *; }
